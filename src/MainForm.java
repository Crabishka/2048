        ...
        MainPanel.addKeyListener(new KeyAdapter() {
            ...
            public void keyReleased(KeyEvent e) {
                if (e.getKeyCode() == KeyEvent.VK_UP) {
                    if (game.doShift(Game.Direction.UP)) game.addRandomCell();
                    updateView();
                }
                if (e.getKeyCode() == KeyEvent.VK_DOWN) {
                    if (game.doShift(Game.Direction.DOWN)) game.addRandomCell();
                    updateView();
                }
                if (e.getKeyCode() == KeyEvent.VK_LEFT) {
                    if (game.doShift(Game.Direction.LEFT)) game.addRandomCell();
                    updateView();
                }
                if (e.getKeyCode() == KeyEvent.VK_RIGHT) {
                    if (game.doShift(Game.Direction.RIGHT)) game.addRandomCell();
                    updateView();
                }
